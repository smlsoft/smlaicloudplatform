...
type MerchantServiceOld struct {
	ms  *microservice.Microservice
	cfg microservice.IConfig
}

func NewMerchantServiceOld(ms *microservice.Microservice, cfg microservice.IConfig) *MerchantServiceOld {
	...
	return &MerchantServiceOld{
		ms:  ms,
		cfg: cfg,
	}
}

func (svc *MerchantServiceOld) RouteSetup() {
...
func (svc *MerchantServiceOld) SearchMerchant(ctx microservice.IServiceContext) error {
...
func (svc *MerchantServiceOld) CreateMerchant(ctx microservice.IServiceContext) error {
...
func (svc *MerchantServiceOld) DeleteMerchant(ctx microservice.IServiceContext) error {
	authUsername := ctx.UserInfo().Username
	id := ctx.Param("id")
...
func (svc *MerchantServiceOld) EditMerchant(ctx microservice.IServiceContext) error {
...
func (svc *MerchantServiceOld) InfoMerchant(ctx microservice.IServiceContext) error {
	username := ctx.UserInfo().Username
	id := ctx.Param("id")
