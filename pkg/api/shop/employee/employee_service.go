...
type IEmployeeService interface {
	Login(shopID string, loginReq models.EmployeeRequestLogin) (string, error)
...
func (svc EmployeeService) Login(shopID string, loginReq models.EmployeeRequestLogin) (string, error) {
