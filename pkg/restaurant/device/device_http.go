...
import (
	...
	"smlcloudplatform/pkg/restaurant/device/services"
...
func (h DeviceHttp) SearchDevicePage(ctx microservice.IContext) error {
	...
	docList, pagination, err := h.svc.SearchDevice(shopID, q, page, limit, sort)
...
func (h DeviceHttp) SearchDeviceLimit(ctx microservice.IContext) error {
	...
	docList, total, err := h.svc.SearchDeviceStep(shopID, lang, q, offset, limit, sorts)
