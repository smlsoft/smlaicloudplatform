...
import (
	...
	"smlcloudplatform/pkg/restaurant/staff/services"
...
func (h StaffHttp) SearchStaffPage(ctx microservice.IContext) error {
	...
	docList, pagination, err := h.svc.SearchStaff(shopID, q, page, limit, sort)
...
func (h StaffHttp) SearchStaffLimit(ctx microservice.IContext) error {
	...
	docList, total, err := h.svc.SearchStaffStep(shopID, lang, q, offset, limit, sorts)
