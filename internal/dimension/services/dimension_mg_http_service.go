...
type IDimensionMGHttpService interface {
...
type DimensionMGHttpService struct {
...
func NewDimensionMGHttpService(
	repo repositories.IDimensionRepository,
	syncCacheRepo mastersync.IMasterSyncCacheRepository,

	contextTimeout time.Duration,
) *DimensionMGHttpService {

	insSvc := &DimensionMGHttpService{
		repo:          repo,
...
func (svc DimensionMGHttpService) getContextTimeout() (context.Context, context.CancelFunc) {
	return context.WithTimeout(context.Background(), svc.contextTimeout)
}

func (svc DimensionMGHttpService) CreateDimension(shopID string, authUsername string, doc models.Dimension) (string, error) {
...
func (svc DimensionMGHttpService) UpdateDimension(shopID string, guid string, authUsername string, doc models.Dimension) error {
...
func (svc DimensionMGHttpService) DeleteDimension(shopID string, guid string, authUsername string) error {
...
func (svc DimensionMGHttpService) DeleteDimensionByGUIDs(shopID string, authUsername string, GUIDs []string) error {
...
func (svc DimensionMGHttpService) InfoDimension(shopID string, guid string) (models.DimensionInfo, error) {
...
func (svc DimensionMGHttpService) SearchDimension(shopID string, filters map[string]interface{}, pageable micromodels.Pageable) ([]models.DimensionInfo, mongopagination.PaginationData, error) {
...
func (svc DimensionMGHttpService) SearchDimensionStep(shopID string, langCode string, filters map[string]interface{}, pageableStep micromodels.PageableStep) ([]models.DimensionInfo, int, error) {
...
func (svc DimensionMGHttpService) saveMasterSync(shopID string) {
...
func (svc DimensionMGHttpService) GetModuleName() string {
	return "dimension"
}
