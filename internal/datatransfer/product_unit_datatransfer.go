...
type IProductUnitDataTransferRepository interface {
	FindPage(ctx context.Context, shopID string, searchInFields []string, pageable micromodels.Pageable) ([]models.UnitDoc, mongopagination.PaginationData, error)
}
...
func (repo ProductUnitDataTransferRepository) FindPage(ctx context.Context, shopID string, searchInFields []string, pageable micromodels.Pageable) ([]models.UnitDoc, mongopagination.PaginationData, error) {
