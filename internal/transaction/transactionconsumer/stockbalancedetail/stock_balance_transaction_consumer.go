...
import (
	...
	stockbalanceConfig "smlcloudplatform/internal/transaction/stockbalancedetail/config"
...
type StockReceiveTransactionConsumer struct {
	...
	transactionPhaser    usecases.ITransactionPhaser[models.StockBalanceTransactionDetailPG]
	stockPhaser          usecases.IStockTransactionPhaser[models.StockBalanceTransactionDetailPG]
...
func InitStockReceiveTransactionConsumer(ms *microservice.Microservice, cfg pkgConfig.IConfig) services.ITransactionDocConsumer {
	...
	repo := NewStockReceiveTransactionDetailPGRepository(persister)
...
func NewStockReceiveTransactionConsumer(
	...
	stockReceiveStockPhaser := StockBalanceDetailStockPhaser{}
